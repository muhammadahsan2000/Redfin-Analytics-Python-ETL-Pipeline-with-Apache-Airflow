...
# s3 buckets
target_bucket_name = 'redfin-transformdata-ah'
...
def extract_data(**kwargs):
    ...
    output_file_path = f"/home/muhammadahsan/airflow/data/output/"+file_str
...
def load_raw_Data_To_bucket(**kwargs):
     ...
     s3_client.put_object(Bucket='redfin-rawdata-ah', Key=object_key, Body=data)
